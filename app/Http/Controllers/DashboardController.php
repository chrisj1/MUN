...
class DashboardController extends Controller
{
    ...
    public function payment()
    {
        ...
        return view('dashboard.payment', ['paid' => $paid_amount, 'cost' => Utils::money_format('%#10n', $cost),
            'price_per_delegate' => Utils::money_format(
                '%#10n', DashboardController::$price_per_delegate),
            'amount_due' => Utils::money_format('%#10n', $cost - $paid_amount)]);
    }
    ...
    public function requestPos(User $user, Request $request) {
	    ...
	    Mail::send('emails.requestChanged', ['user' => $user, 'req'=>$req, '$pos' => $pos, 'committees'=>$committees]
		    , function ($m) use (
