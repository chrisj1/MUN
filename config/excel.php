...
return array(
	...
	'cache' => array(
		...
		*/
		'settings' => array(
			...
			'memoryCacheSize' => '32MB', 'cacheTime' => 600
	...
	'properties' => array('creator' => 'Maatwebsite', 'lastModifiedBy' => 'Maatwebsite', 'title' => 'Spreadsheet', 'description' => 'Default spreadsheet export', 'subject' => 'Spreadsheet export', 'keywords' => 'maatwebsite, excel, export', 'category' => 'Excel', 'manager' => 'Maatwebsite', 'company' => 'Maatwebsite',),
	...
	*/
	'sheets' => array(
		...
		|--------------------------------------------------------------------------
		*/
		'pageSetup' => array('orientation' => 'portrait', 'paperSize' => '9', 'scale' => '100', 'fitToPage' => false, 'fitToHeight' => true, 'fitToWidth' => true, 'columnsToRepeatAtLeft' => array('', ''), 'rowsToRepeatAtTop' => array(0, 0), 'horizontalCentered' => false, 'verticalCentered' => false, 'printArea' => null, 'firstPageNumber' => null,),),
	...
	*/
		...
		'pdf' => array(
			...
			*/
			'drivers' => array(
				...
				|--------------------------------------------------------------------------
				*/
				'DomPDF' => array('path' => base_path('vendor/dompdf/dompdf/')),
				...
				|--------------------------------------------------------------------------
				*/
				'tcPDF' => array('path' => base_path('vendor/tecnick.com/tcpdf/')),
				...
				|--------------------------------------------------------------------------
				*/
				'mPDF' => array('path' => base_path('vendor/mpdf/mpdf/')),))),
	...
	'filters' => array(/*
        ...
        */
		...
		'registered' => array('chunk' => 'Maatwebsite\Excel\Filters\ChunkReadFilter'),
	...
	'views' => array(
		...
		*/
		...
		'styles' => array(
			...
			|--------------------------------------------------------------------------
			*/
			'th' => array('font' => array('bold' => true, 'size' => 12,)),
			...
			*/
			...
			/*
			 ...
			 |--------------------------------------------------------------------------
			 */
			'a' => array('font' => array('underline' => true, 'color' => array('argb' => 'FF0000FF'),)),
			...
			/*
			 ...
			 |--------------------------------------------------------------------------
			 */
			'hr' => array('borders' => array('bottom' => array('style' => 'thin', 'color' => array('FF000000')),)))
